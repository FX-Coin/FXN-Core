...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='fxn.conf'
CONFIGFOLDER='/root/.fxn'
COIN_DAEMON='fxnd'
COIN_CLI='fxn-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/FX-Coin/FXN-Core.git'
COIN_TGZ=https://github.com/FX-Coin/FXN-Core/releases/download/v1.0.0.0/fxn-1.0.0.0-x86_64-linux-gnu.zip'
...
#ADDNODES
addnode=164.68.110.103:16018
addnode=164.68.111.75:16018
addnode=116.203.156.64:16018
addnode=159.69.190.7:16018
addnode=95.216.164.118:16018
addnode=116.202.26.146:16018
addnode=164.68.106.143:16018
EOF
}
