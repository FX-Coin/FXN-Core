Contributing to FXN Core
============================

The FXN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FXN Core project, and is not to be
confused with overall FXN Network Protocol consensus changes.

Whether a pull request is merged into FXN Core rests with the project merge
...
Patches that change FXN consensus rules are considerably more involved than
...
Where a patch set proposes to change the FXN consensus, it must have been
...
The project leader is the release manager for each FXN Core release.
