...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start FXN after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start FXN on system login", 0));
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        checkBoxZeromintEnable->setToolTip(QApplication::translate("OptionsDialog", "Enable automatic minting of FXN units to zFXN", 0));
#endif // QT_NO_TOOLTIP
        checkBoxZeromintEnable->setText(QApplication::translate("OptionsDialog", "Enable zFXN Automint", 0));
#ifndef QT_NO_TOOLTIP
        percentage_label->setToolTip(QApplication::translate("OptionsDialog", "Percentage of incoming FXN which get automatically converted to zFXN via Zerocoin Protocol (min: 10%)", 0));
#endif // QT_NO_TOOLTIP
        percentage_label->setText(QApplication::translate("OptionsDialog", "Percentage of autominted zFXN", 0));
#ifndef QT_NO_TOOLTIP
        labelPreferredDenom->setToolTip(QApplication::translate("OptionsDialog", "Wait with automatic conversion to Zerocoin until enough FXN for this denomination is available", 0));
#endif // QT_NO_TOOLTIP
        labelPreferredDenom->setText(QApplication::translate("OptionsDialog", "Preferred Automint zFXN Denomination", 0));
#ifndef QT_NO_TOOLTIP
        preferredDenom->setToolTip(QApplication::translate("OptionsDialog", "Wait with automatic conversion to Zerocoin until enough FXN for this denomination is available", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the FXN client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the FXN network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting FXN.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/FX-Coin/fxn-core-translations", 0));
