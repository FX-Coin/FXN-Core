                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received FXN from zFXN"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zFXN"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zFXN));
