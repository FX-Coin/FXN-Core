...
// Copyright (c) 2015-2017 The FXN developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("FXN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FXN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fxn: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zFXN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FXN Core"), this);
    aboutAction->setStatusTip(tr("Show information about FXN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FXN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FXN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FXN addresses"));
    ...
    openAction->setStatusTip(tr("Open a FXN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FXN Core help message to get a list with possible FXN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FXN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FXN network", "", count));
}
...
{
    QString strTitle = tr("FXN Core"); // default title
