...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FXN features */
        {"fxn", "masternode", &masternode, true, true, false},
        {"fxn", "listmasternodes", &listmasternodes, true, true, false},
        {"fxn", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fxn", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fxn", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fxn", "masternodedebug", &masternodedebug, true, true, false},
        {"fxn", "startmasternode", &startmasternode, true, true, false},
        {"fxn", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fxn", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fxn", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fxn", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fxn", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fxn", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fxn", "mnbudget", &mnbudget, true, true, false},
        {"fxn", "preparebudget", &preparebudget, true, true, false},
        {"fxn", "submitbudget", &submitbudget, true, true, false},
        {"fxn", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fxn", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fxn", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fxn", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fxn", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fxn", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fxn", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fxn", "checkbudgets", &checkbudgets, true, true, false},
        {"fxn", "mnsync", &mnsync, true, true, false},
        {"fxn", "spork", &spork, true, true, false},
        {"fxn", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"fxn", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use fxnd, or the -server option to fxn-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> fxn-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16881/\n";
}
