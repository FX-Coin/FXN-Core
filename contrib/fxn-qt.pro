...
RESOURCES += src/qt/fxn.qrc src/qt/fxn_locale.qrc

TRANSLATIONS += src/qt/locale/fxn_bg.ts \
                src/qt/locale/fxn_de.ts \
                src/qt/locale/fxn_en.ts \
                src/qt/locale/fxn_es.ts \
                src/qt/locale/fxn_fi.ts \
                src/qt/locale/fxn_fr.ts \
                src/qt/locale/fxn_it.ts \
                src/qt/locale/fxn_ja.ts \
                src/qt/locale/fxn_pl.ts \
                src/qt/locale/fxn_pt.ts \
                src/qt/locale/fxn_ru.ts \
                src/qt/locale/fxn_sk.ts \
                src/qt/locale/fxn_sv.ts \
                src/qt/locale/fxn_vi.ts \
                src/qt/locale/fxn_zh_CN.ts \
                src/qt/locale/fxn_zh_TW.ts
