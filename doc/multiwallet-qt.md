...
In order to support loading of multiple wallets in fxn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fxn.cpp.
...
Changes to fxn.cpp
----------------------
fxn.cpp is the entry point into fxn-qt, and as such, will require some minor modifications to provide hooks for
